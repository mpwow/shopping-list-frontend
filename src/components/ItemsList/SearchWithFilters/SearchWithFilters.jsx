        ...
        <div className={styles.searchAndFiltersContainer}>
            <div className={styles.searchAndFiltersBar}>
                <div className={styles.filtersBar}>
                    <button className={filter === 'all' ? styles.activeButton : ''}
                            onClick={() => filterChangeHandler('all')}>
                        <span>All</span>
                    </button>
                    <button className={filter === 'active' ? styles.activeButton : ''}
                            onClick={() => filterChangeHandler('active')}>
                        <span>Active</span>
                    </button>
                    <button className={filter === 'completed' ? styles.activeButton : ''}
                ...
                <div>
                    <button className={styles.searchButton} onClick={() => {
                        ...
                        {showSearchBar ? <SearchIconFilled className={styles.searchBarIcon}/> :
                            <SearchIcon className={styles.searchBarIcon}/>}
                    </button>
                </div>
            </div>
            {showSearchBar && <div className={styles.searchBar}>
                <input ref={searchRef} value={searchQuery} onChange={(event) => {
